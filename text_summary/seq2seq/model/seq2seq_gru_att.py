...
class Encoder(nn.Module):
    def __init__(self, input_dim, emb_dim, enc_hid_dim, dec_hid_dim, dropout, num_layers=1):
        super().__init__()
...
class Decoder(nn.Module):
    def __init__(self, output_dim, emb_dim, enc_hid_dim, dec_hid_dim, dropout, attention, num_layers=1):
        super().__init__()
        self.output_dim = output_dim
        self.attention = attention
        self.embedding = nn.Embedding(output_dim, emb_dim)
        self.rnn = nn.GRU((enc_hid_dim * 2) + emb_dim, dec_hid_dim, batch_first=True, num_layers=num_layers)
...
class Seq2Seq_Att(nn.Module):
    def __init__(self, input_dim, output_dim,
                 device,
                 encode_embedding_dim=256, decode_embedding_dim=256,
                 encode_hidden_dim=512, decode_hidden_dim=512,
                 num_layers=1,
                 encode_dropout=0.5, decode_dropout=0.5):
        super().__init__()
        self.attention = Attention(encode_hidden_dim, decode_hidden_dim)
        self.encoder = Encoder(input_dim, encode_embedding_dim, encode_hidden_dim, decode_hidden_dim, encode_dropout,
                               num_layers)
        self.decoder = Decoder(output_dim, decode_embedding_dim, encode_hidden_dim, decode_hidden_dim, decode_dropout,
