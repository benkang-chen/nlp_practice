...
class Seq2Seq(nn.Module):
    def __init__(self,
        ...
        super().__init__()
        self.encoder = Encoder(input_dim, encode_embedding_dim, encode_hidden_dim, num_layers, encode_dropout)
        self.decoder = Decoder(output_dim, decode_embedding_dim, decode_hidden_dim, num_layers, decode_dropout)
        self.device = device
